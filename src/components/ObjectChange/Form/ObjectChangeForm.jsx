...
function ObjectChangeForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const formattedDate = formData.date ? formData.date.trim() : new Date().toISOString().split('T')[0];
    
    const changeData = {
      ...formData,
      date: formattedDate, // Asegurar que la fecha esté limpia y bien formateada
